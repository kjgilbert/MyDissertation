...
\end{tabular}
\label{tab:ne-1}
\caption{Programs tested in this study with input parameters or other specifications used. \\
$\dagger$ \footnotesize{The smallest maximum \emph{N}$_e$ allowed by \textsc{estim} is 10,000.} \\
...
best performing methods. Gray boxes indicate the method with the lowest RMSE for that demography 
