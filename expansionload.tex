...
This is clearly seen within each mutation case where steeper environmental gradients slows the speed of expansion (F = 1488, df = 2, p-value < 0.001; Figures \ref{fig:speed}). The leptokurtic dispersal kernel resulted in faster expansion over the landscape (F = 246, df = 1, p-value < 0.001). Increasing the deleterious genomic mutation rate slightly, but significantly decreases the speed of expansion (F = 162.1, df = 2, p-value < 0.001). We find a significant interaction of environmental gradient with the presence of deleterious mutations on expansion speed (F = 62.46, df = 4, p-value < 0.01), where increasing \emph{b} and U result in slower expansion than increasing either individually.

\emph{need to check I've done stats right - do I want to control for random effects of the variable not of interest in each case, or do them all as one big model like: aov(expansion.speed \~ b*U*disp, data=exp.speeds)}
...
As expected, we found that increasing the steepness of the gradient increases migration load in populations (Figure \ref{fig:load}). 
...
\caption{Fitness and expansion speed results per scenario parameter combinations +/- 1 standard error.}
\label{tab:paramresults}
\begin{tabular}{p{0.1\textwidth}|p{0.125\textwidth}|p{0.12\textwidth}|p{0.175\textwidth}|p{0.075\textwidth}|p{0.15\textwidth}|p{0.11\textwidth}}
...
Gradient (\emph{b})		  & Mutation Rate (U) 	&				   & Speed 			& \scriptsize{Core / Edge} & \scriptsize{Core / Edge} 		   & \scriptsize{Core / Edge} \\ \hline \hline
0.0                        & 0.0	& Gaussian         &	3.741 +/- 0.005	&                            &                                         &                                       \\
0.0375                     & 0.0	& Gaussian         &	2.314 +/- 0.011	&                            &                                         &                                       \\
0.375                      & 0.0	& Gaussian         &	0.756 +/- 0.003	&                            &                                         &                                       \\ \hline
0.0                        & 0.1	& Gaussian         &	3.559 +/- 0.008	&                            &                                         &                                       \\
0.0375                     & 0.1	& Gaussian         &	2.283 +/- 0.011	&                            &                                         &                                       \\
0.375                      & 0.1	& Gaussian         &	0.744 +/- 0.002	&                            &                                         &                                       \\ \hline
0.0                        & 1.0	& Gaussian         &	2.285 +/- 0.014	&                            &                                         &                                       \\
0.0375                     & 1.0	& Gaussian         &	1.991 +/- 0.011	&                            &                                         &                                       \\
0.375                      & 1.0	& Gaussian         &	0.595 +/- 0.002	&                            &                                         &                                       \\ \hline
0.0                        & 0.0	& Leptokurtic      &	5.689 +/- 0.010	&                            &                                         &                                       \\
0.0375                     & 0.0	& Leptokurtic      &	2.695 +/- 0.014	&                            &                                         &                                       \\
0.375                      & 0.0	& Leptokurtic      &	0.736 +/- 0.002	&                            &                                         &                                       \\ \hline
0.0                        & 0.1	& Leptokurtic      &	5.355 +/- 0.030	&                            &                                         &                                       \\
0.0375                     & 0.1	& Leptokurtic      &	2.637 +/- 0.019	&                            &                                         &                                       \\
0.375                      & 0.1	& Leptokurtic      &	0.721 +/- 0.002	&                            &                                         &                                       \\ \hline
0.0                        & 1.0	& Leptokurtic      &	3.377 +/- 0.045	&                            &                                         &                                       \\
0.0375                     & 1.0	& Leptokurtic      &	2.285 +/- 0.014	&                            &                                         &                                       \\
0.375                      & 1.0	& Leptokurtic      &	0.577 +/- 0.004	&                            &                                         &                                       \\ \hline
\end{tabular}
\end{table}
