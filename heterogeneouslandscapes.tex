...
\caption[Time spent delayed below the step during expansion.]{Time spent (in generations) delayed below the step during expansion over 1 step in the environment for each regime of genetic architecture simulated and across varying magnitudes of step height. Points are jittered for visualization. All points beyond hte vertical dashed line are censored and did not expand during the course of the simulation.}
\label{fig:waittimes}
