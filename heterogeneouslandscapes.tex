...
\section{Abstract}
Range expansions are complex evolutionary and ecological processes. From an evolutionary standpoint, a populations' adaptive capacity is a major factor in determining the success or failure of  expansion. The ability to adapt over rugged landscapes that change heterogeneously in space has not yet investigated by studies of range expansions. We investigate how patchy environmental gradients and genetic architecture determine species range expansion. We find that both of these factors impact adaptation and expansion over the landscape. Many genes of small effect or few of large effect allow adaptation to newly encountered environments, but the intermediate between these extremes makes adaptation most difficult. Steeper gradients also prevent expansion, but breaking a linear gradient into local patches with sharp changes in phenotypic optimum also increases the difficulty of adaptation and expansion. %% have less about previous studies - that goes in intro, here be explicit about what we did and found
